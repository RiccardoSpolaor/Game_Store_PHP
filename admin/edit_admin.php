        ...
        <section class= "main_content">
            ...
            <div class = 'admin_layout' align="center">
                ...
                <section class = 'panel' align="center">
                    ...
                    SELECT * 
                    FROM user_table 
                    WHERE login = :login AND admin is true
                    ";
                    ...
                    <div class = 'panel_title' id = 'admins_title'>
                        ...
                        MODIFICA ADMIN &nbsp; <?php echo $result['login'].($_SESSION['username']==$_GET['login']?' (Tu)':''); ?>
                    ...
                    <div class = 'edit_panel' id="edit_admin_panel" align="center">
                        ...
                        if (isset($_POST['delete'])) {
                            ...
                            $database_handler = null;
                            if ($result) {
                                echo "Rimozione Admin riuscita.";
                            }
                            else {
                                echo 'Rimozione Admin non riuscita.';
                            }
                            $database_handler = null;
                        ...
                        if (isset ($_POST['submit'])) {
                            ...
                            ";
                                ...
                                if ($success) {
                                    header ('Location: edit_admin.php?login='.$_GET['login']);
                                }
                            }
